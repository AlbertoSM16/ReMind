...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|p{2.5cm}|X|p{1.5cm}|} 
        ...
        \hline
        \textbf{Descripción} & \multicolumn{2}{|>{\raggedright\arraybackslash}X|}{Usuario con todos los privilegios del sistema} \\ 
        \hline
        \textbf{Características} & \multicolumn{2}{|>{\raggedright\arraybackslash}X|}{Perfil destinado a los usuarios que dan de alta a los usuarios terapeutas} \\ 
        \hline
        \textbf{Relaciones} & \multicolumn{2}{|>{\raggedright\arraybackslash}X|}{RF-1.1} \\ 
        \hline
    \end{tabularx}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|p{2.5cm}|X|p{1.5cm}|} 
        ...
        \hline
        \textbf{Descripción} & \multicolumn{2}{|>{\raggedright\arraybackslash}X|}{Usuario con priveligios sobre el paciente} \\ 
        \hline
        \textbf{Características} & \multicolumn{2}{|>{\raggedright\arraybackslash}X|}{Perfil destinado a los usuarios terapeutas, que supervisan a los pacientes} \\ 
        \hline
        \textbf{Relaciones} & \multicolumn{2}{|>{\raggedright\arraybackslash}X|}{RF-1.2,RF-1.3,RF-1.4,RF-2.1,RF-3.2,RF-3.3,RF-3.4,RF-3.5,RF-3.6,RF-5.1,RF-5.3} \\ 
        \hline
    \end{tabularx}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|p{2.5cm}|X|p{1.5cm}|} 
        ...
        \hline
        \textbf{Descripción} & \multicolumn{2}{|>{\raggedright\arraybackslash}X|}{Usuario destinado a realizar los juegos} \\ 
        \hline
        \textbf{Características} & \multicolumn{2}{|>{\raggedright\arraybackslash}X|}{Perfil destinado a realizar los juegos que les son propuestos} \\ 
        \hline
        \textbf{Relaciones} & \multicolumn{2}{|>{\raggedright\arraybackslash}X|}{RF-3.6,RF-5.2,RF-5.3,RF-5.4,RF-5.5,RF-5.6,RF-5.7,RF-4} \\ 
        \hline
    \end{tabularx}
